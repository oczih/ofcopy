  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
        <div className="bg-slate-900 border border-slate-700/50 rounded-3xl shadow-2xl p-8 w-[90%] sm:w-[80%] md:w-full max-w-md relative animate-scale-in overflow-hidden">
...
<div className="flex flex-col gap-3 w-full">
  <button
    ...
    disabled={isLoading}
    className="flex items-center gap-2 w-full justify-center py-2 rounded-full bg-white/10 text-white hover:border-white hover:border transition-all duration-300 disabled:opacity-50"
  >
  ...
  {passwordField && (
    <div className="w-full relative">
      <input
        ...
        className={`w-full pl-4 pr-10 py-3 bg-white/10 rounded-xl shadow-sm text-white placeholder-gray-400 hover:outline hover:outline-white transition-all duration-200 ${
  ...
  <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
    <div className="bg-slate-800 border border-slate-600 rounded-2xl shadow-2xl p-6 w-full max-w-md relative">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-end">
        <button
          className="px-6 py-2 rounded-xl text-gray-300 hover:text-white hover:bg-slate-700 transition-colors w-full sm:w-auto"
          onClick={handleLeave}
        >
          Leave
        </button>
        <button
          className="bg-purple-500 hover:bg-purple-600 text-white px-6 py-2 rounded-xl font-semibold transition-colors w-full sm:w-auto"
          onClick={handleStay}
        >
          Stay
        </button>
