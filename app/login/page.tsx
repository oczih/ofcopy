        ...
        {/* Login Method Toggle */}
          <div className="flex flex-col gap-3 w-full">
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 w-full justify-center py-2 border-transparent rounded-full bg-white/10 text-white hover:border-white hover:border duration-300 transition-colors disabled:opacity-50 cursor-pointer"
            >
          ...
          <div className="space-y-4 w-full">
            ...
            <div>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-3 text-gray-400 cursor-pointer hover:text-purple-600 transition-colors"
                >
            ...
            <div className="text-right">
              <button
                ...
                className="text-xs text-purple-600 cursor-pointer hover:text-purple-500 underline"
              >
                Forgot password?
              </button>
            </div>
