          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="space-y-6">
              {posts.map((post, index) => (
                <div 
                  key={post.id} 
                  className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 overflow-hidden hover:bg-white/10 transition-all hover:scale-[1.01] shadow-2xl animate-fade-in"
