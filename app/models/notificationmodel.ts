...
export type NotificationType = 'newsub' | 'resub' | 'tip' | 'subcancel' | 'comment' | 'like' | 'newfollower' | 'promotion' | 'post' | 'message';
...
const notificationSchema = new Schema<NotificationDocument>({
  type: { 
    type: String, 
    enum: ['newsub', 'resub', 'tip', 'subcancel', 'comment', 'like', 'newfollower', 'promotion', 'post', 'message'], 
    required: true 
  },
